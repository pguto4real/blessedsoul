            ...
            <div className="row d-flex align-items-center">
              <div className="col-xl-6 offset-xl-1 col-lg-6 offset-lg-1 col-md-7 offset-md-1">
                <div className="header-info">
                  <span>
                    <i className="fas fa-phone"></i> +1 347 335-4884
                  </span>
                  <span>
                    <i className="fas fa-envelope"></i>{" "}
                    info@blessedsoulhealthcarellc.com{" "}
                  </span>
                </div>
              </div>
            ...
            <div className="row align-items-center">
              <div className="col-xl-3 col-lg-3 col-md-6 col-6 d-flex align-items-center">
                <div className=" flex flex-row justify-between">
                  ...
                  <p className="flex justify-center items-center text-[30px] font-bold mb-0 text-black">
                    BlessedSoul
                  </p>
                </div>
              </div>
